...
class ProviderProfileModel {
  ...
  // ✅ لتحديث النسخة بدون إعادة جلب البيانات من السيرفر
...
class ProfileData {
  ...
  final List<CertificateModel>? certificates;
  final List<PortfolioModel>? portfolio;
  final bool? isFavourite; // ✅ الحقل الجديد
  ...
  factory ProfileData.fromJson(Map<String, dynamic> json) {
    ...
    return ProfileData(
      ...
      // ✅ يقبل is_favourite سواء جاي bool أو 0/1 أو null
  ...
  // ✅ لتبديل حالة المفضلة محليًا فورًا (optimistic update)
