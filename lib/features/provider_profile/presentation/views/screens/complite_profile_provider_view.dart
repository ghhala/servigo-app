...
class _CompliteProfileProviderViewState extends State<CompliteProfileProviderView> {
  ...
  void initState() {
    ...
    int dynamicMainServiceId = 1; 

    if (widget.userData != null) {
      if (widget.userData!.containsKey('main_service_id') && widget.userData!['main_service_id'] != null) {
        dynamicMainServiceId = int.tryParse(widget.userData!['main_service_id'].toString()) ?? dynamicMainServiceId;
      } 
        ...
        dynamicMainServiceId = int.tryParse(widget.userData!['data']['main_service_id'].toString()) ?? dynamicMainServiceId;
      } 
        ...
        dynamicMainServiceId = int.tryParse(widget.userData!['user']['main_service_id'].toString()) ?? dynamicMainServiceId;
      }
        ...
        dynamicMainServiceId = int.tryParse(widget.userData!['data']['user']['main_service_id'].toString()) ?? dynamicMainServiceId;
      }
    }
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                CustomTextFormFiled(
                                  ...
                                  hintText: "Enter a description of your location to help customers find you",
                      ...
                      return CustomButton(
                        ...
                        onTap: () {
                          ...
                          if (_locationController.text.isEmpty ||
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(
                              const SnackBar(
                                content: Text("Please fill in location, about me, select a sub category, and upload your profile photo"),
